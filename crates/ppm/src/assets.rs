pub const EMBEDDED_REDIRECTOR_DLL: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/redirector.dll"));

pub const DEFAULT_APPS_JSON: &str = r#"{
  ...
  "apps": {
    ...
    "webview2": {
      ...
      "version_check": {
        ...
        "version_key": "/2/Releases/2/ProductVersion",
        "url_key": "/2/Releases/2/Artifacts/0/Location"
      },
      "package": {
        "type": "msi"
      }
